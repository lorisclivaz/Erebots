...
class CustomChatGatewayAgent(AbstractCovid19GatewayAgent):
    """The CustomChat Gateway Agent between the chat and the Multi-Agent System for Covid19 project"""
    ...
    class CheckUserRegistrationState(
        ...
        def __init__(self, chat_api_token: str):
            ...
            AbstractCovid19GatewayAgent.AbstractCheckUserRegistrationState.__init__(self, chat_api_token)
    ...
    class HandleUserRegistrationResponseState(
        ...
        def __init__(self, chat_api_token: str):
            # with multiple inheritance all constructors must be called explicitly
            super().__init__(chat_api_token)
            AbstractCovid19GatewayAgent.AbstractHandleUserRegistrationResponseState.__init__(self, chat_api_token)
